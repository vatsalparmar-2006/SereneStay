...
{
    /// <inheritdoc />
    public partial class RoomRoomNumberToInt : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDProofType = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    IDProofNumber = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomNumber = table.Column<int>(type: "int", unicode: false, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceCharges = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceUsage", x => x.UsageID);
                    table.ForeignKey(
                        name: "FK_ServiceUsage_Bookings_BookingID",
                        column: x => x.BookingID,
                        principalTable: "Bookings",
                        principalColumn: "BookingID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Rooms__AE10E07AE5F85279",
                table: "Rooms",
                column: "RoomNumber",
                unique: true);
